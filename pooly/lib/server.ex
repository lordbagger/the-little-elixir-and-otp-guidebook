defmodule Pooly.Server do
  ...
  defmodule State do
    defstruct sup: nil, size: nil, mfa: nil, worker_sup: nil, monitors: nil, workers: nil
  end
  ...
  def handle_call(:checkout, {from_pid, _ref}, %{workers: workers, monitors: _monitors} = state) do
    case workers do
      [worker|rest] ->
